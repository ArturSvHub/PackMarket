...
namespace PackMarket.Migrations
{
    ...
    [Migration("20230226091013_remake-state")]
    partial class remakestate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OptionOptionList", b =>
                {
                    b.Property<int>("OptionListsId")
                        .HasColumnType("integer");

                    b.Property<int>("OptionsId")
                        .HasColumnType("integer");

                    b.HasKey("OptionListsId", "OptionsId");

                    b.HasIndex("OptionsId");

                    b.ToTable("OptionOptionList");
                });
            ...
            modelBuilder.Entity("PackMarket.Data.Models.Option", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PackMarket.Data.Models.OptionList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PackMarket.Data.Models.Promo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PackMarket.Data.Models.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OptionOptionList", b =>
                {
                    b.HasOne("PackMarket.Data.Models.OptionList", null)
                        .WithMany()
                        .HasForeignKey("OptionListsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PackMarket.Data.Models.Option", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PackMarket.Data.Models.Category", b =>
                {
                    ...
                    b.HasOne("PackMarket.Data.Models.Category", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("PackMarket.Data.Models.Product", b =>
                {
                    ...
                    b.HasOne("PackMarket.Data.Models.State", "State")
                        .WithMany("Products")
