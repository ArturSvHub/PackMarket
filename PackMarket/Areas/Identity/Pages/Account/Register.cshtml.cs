...
using PackMarket.Data.Static;
using PackMarket.Data.Models;

namespace PackMarket.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if(User.IsInRole(TemplateRoles.Admin))
                    {
                        await _userManager.AddToRoleAsync(user, TemplateRoles.Admin);
                    }
                    else
                    {
                        await _userManager.AddToRoleAsync(user, TemplateRoles.Customer);
                    }
